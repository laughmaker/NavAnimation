...
@property (retain, nonatomic) NavViewController *navViewController;
...
- (void)viewDidLoad
{
    ...
    navViewController = [[NavViewController alloc] initWithNibName:@"NavViewController" bundle:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.navigationController pushViewController:navViewController animated:NO];
}
